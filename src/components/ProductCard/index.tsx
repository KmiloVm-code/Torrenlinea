...
const ProductCard = (props: any) => {
  ...
  return (
    ...
    <div className="flex flex-col justify-between items-center border border-black/10 bg-white rounded-md shadow-md p-2 w-64 sm:w-72 h-80 sm:h-96" onClick={() => handleProductDetail()}>
      ...
      <div className="flex gap-3 mb-2">
        ...
        <button className="bg-primary-500 text-sm sm:text-md font-semibold text-white px-2 sm:px-4 py-1 sm:py-3 rounded-md">Agregar al carrito</button>
      </div>
    </div>
  )
}
